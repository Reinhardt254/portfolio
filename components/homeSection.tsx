...
const HomeSection = () => {
  return (
    <div className="">
      <div className="sm:flex-row flex-col sm:flex sm:justify-between bg-slate-950 md:px-0 px-5 justify-center items-center flex h-full pb-20 max-sm:pt-16">
        <div className="flex flex-col justify-center items-center md:py-5">
          <div className="md:pt-0">
            ...
            <h1 className="text-gray-300 font-bold text-4xl md:text-3xl md:pt-7 pt-8">
              Reinhardt Lagat
            </h1>
            <p className="font-bold md:text-5xl mt-1 text-gray-300 md:pt-7 pt-7 text-3xl">
              I build things for the web
            </p>
            <p className="md:text-xl font-semibold text-gray-400 md:pt-7 md:w-3/4 pt-3 text-lg">
