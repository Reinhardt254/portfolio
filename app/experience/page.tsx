...
const Experience = () => {
  return (
    <main className=" bg-slate-950 h-full flex justify-center items-center py-6">
      <div className="h-full bg-slate-950 w-full flex justify-center items-center py-3 pb-20 pr-4">
        <div className="w-full flex flex-col  mx-4 space-y-5 pl-0">
          ...
          <div>
            <div className="flex justify-start items-center flex-wrap">
              <p className="text-blue-200 font-semibold md::text-xl pr-2 text-lg">
                Software Developer
              </p>
          ...
          <div>
            ...
            <p className="text-gray-400 pt-2">
              I worked as a lead software engineer in designing and building an
          ...
          <div>
            <div className="flex justify-start items-center flex-wrap">
              <h1 className="text-blue-200 font-semibold md:text-xl pr-2 text-lg">
                {" "}
